  ...
  steps: [
    {
      ...
      config: {
        ...
        model: "OpenAI Responses (secure server call)"
      }
    },
    {
      id: "step_http",
    ...
    step_runs: [
      {
        ...
        output: { recommendation: "proceed", confidence: 0.82, summary: "The topic is sufficiently defined for editorial review.", model: "deterministic-fallback" },
        error: null,
