    ...
    step_runs: [
      {
        ...
        error: null,
        started_at: new Date(Date.now() - 69_000).toISOString(),
        completed_at: new Date(Date.now() - 68_400).toISOString()
      },
      {
        id: "sr_demo_2",
        ...
        error: null,
        started_at: new Date(Date.now() - 68_000).toISOString(),
        completed_at: new Date(Date.now() - 67_400).toISOString()
      },
      {
        id: "sr_demo_3",
        ...
        error: null,
        started_at: new Date(Date.now() - 67_000).toISOString(),
        completed_at: new Date(Date.now() - 66_800).toISOString()
      },
      {
        id: "sr_demo_4",
        ...
        approved_by: null,
        approved_at: null,
        started_at: new Date(Date.now() - 66_500).toISOString(),
        completed_at: null
      },
      {
        id: "sr_demo_5",
